...
static volatile bool _haveData = false;     // flag to indicate if received data is available, cleared by RFM69_receiveDone() after reading the data
...
bool RFM69_initialize(uint8_t freqBand, uint8_t nodeID, uint16_t networkID)
{
  const uint8_t CONFIG[][2] =
  {
    ...
    /* 0x03 */ { REG_BITRATEMSB, RF_BITRATEMSB_250000}, // 25 KBPS
    /* 0x04 */ { REG_BITRATELSB, RF_BITRATELSB_250000},
    /* 0x05 */ { REG_FDEVMSB, RF_FDEVMSB_250000}, // 25KHz, (FDEV + BitRate / 2 <= 500KHz)
    ...
    /* 0x19 */ { REG_RXBW, RF_RXBW_DCCFREQ_111 | RF_RXBW_MANT_16 | RF_RXBW_EXP_0 }, // (BitRate < 2 * RxBw)
    //for BR-19200: /* 0x19 */ { REG_RXBW, RF_RXBW_DCCFREQ_010 | RF_RXBW_MANT_24 | RF_RXBW_EXP_3 },
    /* 0x25 */ { REG_DIOMAPPING1, RF_DIOMAPPING1_DIO0_01 }, // DIO0 is the only IRQ we're using
    /* 0x26 */ { REG_DIOMAPPING2, RF_DIOMAPPING2_CLKOUT_OFF }, // DIO5 ClkOut disable for power saving
    /* 0x28 */ { REG_IRQFLAGS2, RF_IRQFLAGS2_FIFOOVERRUN }, // writing to this bit ensures that the FIFO & status flags are reset
    /* 0x29 */ { REG_RSSITHRESH, 220 }, // must be set to dBm = (-Sensitivity / 2), default is 0xE4 = 228 so -114dBm
    /* 0x2D */ { REG_PREAMBLEMSB, RF_PREAMBLESIZE_MSB_VALUE }, // default 4 preamble bytes 0xAAAAAA
    /* 0x2D */ { REG_PREAMBLELSB, RF_PREAMBLESIZE_LSB_VALUE }, // default 4 preamble bytes 0xAAAAAA
